        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="https://www.aquaclub.com.au/">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="https://www.aquaclub.com.au/collections/all">Shop All</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="https://www.aquaclub.com.au/collections/inflatable-docks">Docks</a></li>
                            <li><a class="dropdown-item" href="https://www.aquaclub.com.au/collections/sea-pools">Sea
                                    Pools</a></li>
                            <li><a class="dropdown-item" href="https://www.aquaclub.com.au/collections/lounges">Lounges</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="https://www.aquaclub.com.au/collections/accessories">Accessories</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.aquaclub.com.au/pages/about-2">About us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://www.aquaclub.com.au/pages/contact-us">Contact Us</a>
                    </li>
                </ul>
                <div class="d-flex">
                    <a class="nav-link" href="https://www.aquaclub.com.au/account/login">
                        ...
                        <!-- <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false"
                            class="icon icon-account" fill="none" viewBox="0 0 18 19" height="1.5rem" width="1.5rem">
